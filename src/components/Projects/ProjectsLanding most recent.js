    ...
    render(){
        return(
            <div className="projects-page">
                <Tabs>
                    <TabList className="projects-description">
                        <h1>Projects</h1>
                        ...
                        <div className="scroll-navigation vertical">
                            <Tab className='scroll-menu-item'>Interaction Design</Tab>
                            <Tab className='scroll-menu-item'>Design Workshops</Tab>
                            <Tab className='scroll-menu-item'>Usability Testing</Tab>
                            <Tab className='scroll-menu-item'>User Research</Tab>
                        </div>
                    </TabList>
                            ...
                            <li>
                                <Link to={`${this.props.match.url}/us-army`} className="cs-link" project="USArmy">
                                    <span className="cs-details">
                                        ...
                                        <span className="cs-description">Building Applications for Commanders</span>
                                    </span>
