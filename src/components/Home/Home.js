        ...
        return (
            <div className="homepage">
                <section className="landing-page">
                    ...
                    <Link activeClass="active" to="skillset" onClick={this.scrollDown} spy={true} smooth={true} offset={50} duration={500} delay={1000} className="scroll-down">
                        <MdArrowDownward/>
                    </Link>
                    ...
                    <Element name="skillset">
                        <section className="skillset" ref="skillset">
                ...
                <section className="project-logos" ref={elem => (this.gate = elem)}>
                    <div className="container">
